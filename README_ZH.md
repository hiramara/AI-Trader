...
> **个人备注**：模拟交易账户初始资金为 10 万美元，建议新手先用模拟盘熟悉平台操作至少两周，再考虑接入真实资金或跟单。此外，跟单时注意控制单笔跟单比例，建议不超过总资金的 5%，并定期审查跟单对象的近期表现，避免盲目跟随。平台目前处于快速迭代阶段，遇到问题可优先查阅 [COMMUNICATION.md](./COMMUNICATION.md) 中的社群渠道反馈。
